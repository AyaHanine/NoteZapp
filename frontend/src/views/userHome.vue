  ...
  <div class="flex flex-1 h-full bg-copper-50">
   ...
   <main class="flex-1 flex flex-col">
      <section class="p-8 max-w-7xl mx-auto">
        ...
        <!-- CATEGORIES/FAVORIS/CORBEILLE : flex-wrap classique -->
        ...
        <!-- TOUTES NOTES : carousel + scratchpad/tasklist -->
        <template v-else>
          <!-- Carousel stylé -->
          <div class="mb-7">
            <NotesCarroussel :notes="mainNotes" />
          </div>
          ...
          <div class="flex gap-6 w-full max-w-7xl mx-auto mt-3">
            ...
            <!-- TaskList/Planner à droite, plus étroit -->
