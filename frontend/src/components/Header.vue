<template>
  <header class="w-full bg-copper-900 shadow-md px-6 sm:px-20 py-4 flex justify-between items-center">
      <div class="flex items-center gap-2">
        <span class="text-2xl font-extrabold text-white tracking-tight">NoteZ<span class="text-copper-400">app</span></span>
      </div>
      <nav class="flex gap-10 items-center">
        <a href="#features" class="text-copper-100 hover:text-copper-300 font-medium">Fonctionnalités</a>
